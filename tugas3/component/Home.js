...
const HomeScreen = ({ navigation }) => {
  ...
  const [Tgl, setTgl] = useState(setTgl);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.boxInput}>
        <SafeAreaView>
          <Text style={styles.textInput}>
            <Icon name="plane" size={25} style={{ color: "blue" }}></Icon>{" "}
          ...
          <Text style={styles.textInput}>
            <Icon name="paper-plane" size={25} style={{ color: "blue" }}></Icon>{" "}
            Lokasi Tujuan
          </Text>
          <TextInput
          ...
          <Text style={styles.textInput}>
            <Icon name="calendar" size={25} style={{ color: "blue" }}></Icon>{" "}
      ...
      <Text style={{ textAlign: "center", marginBottom: 10 }}>
        @2022 M.Anwar Ibrahim-119140221
      </Text>
    </View>
  );
};
